...
const FormApplications = () => {
  ...
  const overviewStats = useMemo(() => {
    ...
    const universitiesWithForms = new Set(
      applications.map((app) => courses.find((c) => c.id === app.courseId)?.universityId).filter(Boolean),
    );
    ...
    return (
      <div className="space-y-6">
        ...
        <div className="grid gap-4 md:grid-cols-5">
          ...
          <Card>
            <CardHeader className="pb-3">
              <CardTitle className="text-sm font-medium">Universities22222222222222222222</CardTitle>
            </CardHeader>
            <CardContent>
                ...
                <CardContent className="p-6">
                  <div className="flex items-start justify-between mb-4">
                    <div className="flex-1">
                      <h3 className="text-xl font-semibold text-foreground mb-1">{form.name}</h3>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-2">
                        <h3 className="text-lg font-semibold text-foreground">{app.applicantName}</h3>
